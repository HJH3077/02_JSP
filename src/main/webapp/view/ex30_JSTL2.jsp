...
<body>
	...
	<li><fmt:parseNumber value="123aaaa45.567" /></li>
	<%--
					오류 발생 	
	<li><fmt:formatNumber value="aaaa12345.567" /></li> 
	--%>
	...
	<li><fmt:formatDate value="${now2}" type="time" dateStyle="short" /></li>	
	<li><fmt:formatDate value="${now2}" type="time" dateStyle="medium" /></li>	
	<li><fmt:formatDate value="${now2}" type="time" dateStyle="long" /></li>	
	<li><fmt:formatDate value="${now2}" type="time" dateStyle="full" /></li>	
	<hr>
	
	<li><fmt:formatDate value="${now2}" type="both" dateStyle="short" /></li>	
	<li><fmt:formatDate value="${now2}" type="both" dateStyle="medium" /></li>	
	<li><fmt:formatDate value="${now2}" type="both" dateStyle="long" /></li>	
	<li><fmt:formatDate value="${now2}" type="both" dateStyle="full" /></li>	
	<hr>
